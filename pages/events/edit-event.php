...
<div>
    <form class="needs-validation" action="index.php?menuop=update-event" method="post" novalidate>
    <div class="mb-3 col-3">
        ...
        <div class="row">
            <div class="mb-3 col-3">
                <label for="dataFimEvento" class="form-label">Data do Fim</label>
                <input class="form-control" type="date" name="dataFimEvento" id="dataFimEvento" value="<?=$dados["dataFimEvento"]?>">
            </div>
            <div class="mb-3 col-3">
                <label for="horaFimEvento" class="form-label">Hora do Fim</label>

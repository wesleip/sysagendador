<header class="mt-2">
    <h3><i class="bi bi-list-task"></i> Cadastrar nova tarefa</h3>
</header>

<div>
    <form class="needs-validation" action="index.php?menuop=insert-task" method="post" novalidate>
        <div class="mb-3">
        ...
        <div class="row">
            <div class="mb-3 col-3">
                ...
                <select name="recorrenciaTarefa" id="recorrenciaTarefa" class="form-select custom-select">
